        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Mahasiswa</h3>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mahasiswa_create')): ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="<?php echo e(route('backsite.mahasiswa.store')); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="nim" name="nim"
                                                                ...
                                                                value="<?php echo e(old('nim')); ?>" autocomplete="off" required>

                                                            <?php if($errors->has('nim')): ?>
                                                                <p style="font-style: bold; color: red;">
                                                                    <?php echo e($errors->first('nim')); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mahasiswa_table')): ?>
                <div class="content-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Mahasiswa List</h4>
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        <?php $__empty_1 = true; $__currentLoopData = $mahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mahasiswa_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr data-entry-id="<?php echo e($mahasiswa_item->id); ?>">
                                                                <td><?php echo e(isset($mahasiswa_item->created_at) ? date('d/m/Y H:i:s', strtotime($mahasiswa_item->created_at)) : ''); ?>

                                                                </td>
                                                                <td><?php echo e($mahasiswa_item->name ?? ''); ?></td>
                                                                <td><?php echo e($mahasiswa_item->kelas->name ?? ''); ?></td>
                                                                <td><a data-fancybox="gallery"
                                                                        data-src="<?php echo e(request()->getSchemeAndHttpHost() . '/storage' . '/' . $mahasiswa_item->photo); ?>"
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mahasiswa_show')): ?>
                                                                                <a href="#mymodal"
                                                                                    data-remote="<?php echo e(route('backsite.mahasiswa.show', $mahasiswa_item->id)); ?>"
                                                                            ...
                                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mahasiswa_edit')): ?>
                                                                                <a class="dropdown-item"
                                                                                    href="<?php echo e(route('backsite.mahasiswa.edit', $mahasiswa_item->id)); ?>">
                                                                                    Edit
                                                                                </a>
                                                                            <?php endif; ?>

                                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mahasiswa_delete')): ?>
                                                                                <form
                                                                                    action="<?php echo e(route('backsite.mahasiswa.destroy', $mahasiswa_item->id)); ?>"
                                                                                    method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\report-app-main\resources\views/pages/operational/mahasiswa/index.blade.php ENDPATH**/ ?>